...
const UserCard = ({ type, year, amount }: { type: string, year: string, amount: number }) => {
    return (
        <div className="rounded-lg  odd:bg-hSchoolPurple even:bg-hSchoolYellow p-4 flex-1 min-w-[130px]:">
            <div className="flex justify-between items-center">
                <span className="text-[10px] bg-white px-2 py-1 rounded-full text-emerald-600 font-medium">{year}</span>
